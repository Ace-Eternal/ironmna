...
const CustomerTable = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'action',
            align: 'center',
            render: (_, record) => (_jsxs(Space, { children: [_jsx(Button, { onClick: () => handleDetail(record.id), children: "\u8BE6\u60C5" }), _jsx(Button, { disabled: record.forbid, onClick: () => handleEdit(record), children: "\u7F16\u8F91" }), _jsx(Button, { danger: true, onClick: () => handleDelete(record.id), children: "\u5220\u9664" })] }))
        }
    ];

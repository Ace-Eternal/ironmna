...
const VideoWatermark = () => {
    const [container] = useImmer(containerObj);
    ...
    return (_jsx(PageWrapper, { plugin: VIDEO_WATERMARK, children: _jsxs(Row, { gutter: 12, children: [_jsx(Col, { span: 16, children: _jsx(Card, { title: '\u5408\u6210\u533A\u57DF', bordered: false, bodyStyle: { height: '550px' }, children: _jsx("div", { className: 'flex-center', children: _jsxs("div", { className: 'dnd-container', style: { ...containerStyle }, children: [_jsx("video", { src: container.videoUrl, controls: true, style: { position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' } }), elements.map((item, index) => {
                                    ...
                                    })] }) }) }) }), _jsx(Col, { span: 8, children: _jsxs(Card, { title: '\u8BBE\u7F6E\u533A\u57DF', bordered: false, bodyStyle: { height: '550px' }, children: [_jsxs(Form, { colon: false, labelCol: { span: 6 }, wrapperCol: { span: 18 }, labelAlign: 'left', style: { width: '300px', margin: '0 auto' }, children: [_jsx(Form.Item, { label: '\u9009\u62E9\u89C6\u9891', children: _jsx(Button, { type: 'primary', style: { width: '100%' }, onClick: () => message.warning('请配置视频资源服务接口！'), children: "\u9009\u62E9\u89C6\u9891" }) }), _jsx(Form.Item, { label: '\u6DFB\u52A0\u6587\u672C', children: _jsx(Button, { block: true, style: { width: '100%' }, onClick: handleAddText, children: "\u6DFB\u52A0\u6587\u672C" }) }), _jsx(Form.Item, { label: '\u6DFB\u52A0\u56FE\u7247', children: _jsx(UploadImage, { name: '\u6DFB\u52A0\u56FE\u7247', isFull: true, onSuccess: uploadImage }) }), _jsx(Form.Item, { label: '\u5220\u9664\u5143\u7D20', children: _jsx(Button, { type: 'primary', danger: true, style: { width: '100%' }, onClick: handleDeleteElement, children: "\u5220\u9664\u5143\u7D20" }) })] }), activeElement && activeElement.type === 'text' ? (_jsx(RichTextSetting, { textValue: activeElement.text, textStyles: activeElement.style, onChangeValue: val => handleSettingText(val), onChangeStyles: style => handleSettingStyles(style) })) : (_jsx(_Fragment, {}))] }) })] }) }));
};

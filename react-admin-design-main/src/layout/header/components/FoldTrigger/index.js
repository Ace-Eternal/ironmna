...
export default function FoldTrigger() {
    ...
    return (_jsx("span", { className: classNames(style['compo_fold-trigger'], { [style['unfold']]: !getMenuFold }), onClick: toggledMenuFold, children: _jsx(SvgIcon, { name: 'unfold', size: 20 }) }));
}

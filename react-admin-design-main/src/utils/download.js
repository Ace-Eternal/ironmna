 ...
 * @param bom
 */
export function downloadImgByUrl(url, filename, mineType, bom) {
 ...
 * @param bom
 */
export function downloadImgByBase64(buf, filename, mineType, bom) {
 ...
 * @param {*} bom
 */
export function downloadByData(data, filename, mineType, bom) {
